public class Main {
    ...
    static double classVariable;  // This is static variable that have another name is class variable we can call it directly in static context without creating an object
